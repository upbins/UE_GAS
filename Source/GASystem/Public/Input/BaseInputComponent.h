...
class GASYSTEM_API UBaseInputComponent : public UEnhancedInputComponent
{
	GENERATED_BODY()
...
template <class UserClass, typename PressedFuncType, typename ReleasedFuncType, typename HeldFuncType>
void UBaseInputComponent::BindAbilityActions(const UInputConfig* InputConfig, UserClass* Object,
